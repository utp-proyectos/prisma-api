...
public interface CalendarEventRepository extends JpaRepository<CalendarEvent, Integer> {
    ...
    List<CalendarEvent> findByProject_IdAndActiveTrueOrderByStartDateAsc(String projectId);

    Optional<CalendarEvent> findByIdAndProject_IdAndActiveTrue(Integer id, String projectId);
